...
<?php
  ...
  $updatedwork=updateWork($_GET['id'], getHotelId($_POST['hotelname'])['Id'], $_POST['room'],$_POST['device'][0],$_POST['work'][0], $_POST['days'][0],
  $startingdate, $work['Confirmation'], $work['Notes']);
  echo $updatedwork.'<br>';
  if ($updatedwork=='Work updated') {
