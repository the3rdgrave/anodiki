...
if (isset($_POST['newworkbutton'])){
  ...
  echo addWork(getHotelId($_POST['hotelname'])['Id'], $_POST['room'],$_POST['device'][$i],$_POST['work'][$i],
  $_POST['days'][$i], getHotelId($_POST['hotelname'])['StartingDate']);?> : <?php echo $_POST['work'][$i];?><br>
  <?php
